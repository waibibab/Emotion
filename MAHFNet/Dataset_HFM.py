...
train_path = './HFM/formatted_train_des.txt'  #
test_path = './HFM/formatted_test_des.txt'  #
valid_path = './HFM/formatted_valid_des.txt'
...
if __name__ == '__main__':
    # training
    train_data,valid_data,test_data = get_dataset(64)
    for t in range(1):
